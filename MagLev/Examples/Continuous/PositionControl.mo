...
equation
  ...
  connect(e2d.d, visualization.d) annotation (Line(points={{19,-10},{-40,-10},{-40,-60},{-24,-60}}, color={0,0,127}));
  ...
  connect(e2d.d, positionController.u_m) annotation (Line(points={{19,-10},{-130,-10},{-130,18}},  color={0,0,127}));
